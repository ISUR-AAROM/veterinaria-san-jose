export function Agenda() {
  return (
    <div className="animate-fade-in-up">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#2C1A0E]">Agenda del dia</h1>
        <p className="text-sm text-[#7A6555] mt-1">Gestion de citas y horarios</p>
      </div>
      <div className="bg-white rounded-2xl border border-[#E8DDD0] p-14 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-sm text-[#7A6555] max-w-xs">La agenda visual con calendario y lista de citas estara disponible en la proxima actualizacion.</p>
      </div>
    </div>
  )
}
